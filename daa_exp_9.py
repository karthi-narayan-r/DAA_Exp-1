def first_fit(items, capacity=1.0):
    ...
    bin_contents = []  # Stores items in each bin
...
# Lower bound = ceiling of total size / bin capacity
lower_bound = -(-sum(items) // capacity)

print("Items:", items)
print("Capacity:", capacity)
print("Sum of items:", sum(items))
print("Lower bound on bins:", int(lower_bound))
